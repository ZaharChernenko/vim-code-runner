...
class TestFileInfoExtractorInterface:
    def test_get_dir(self, fixture_file_info_extractor: IFileInfoExtractor) -> None:
    ...
    def test_get_dir_without_trailing_slash(self, fixture_file_info_extractor: IFileInfoExtractor) -> None:
    ...
    def test_get_file_name(self, fixture_file_info_extractor: IFileInfoExtractor) -> None:
        assert fixture_file_info_extractor.get_file_name("/home/user/project/file.py") == "file.py"

    def test_get_file_name_without_ext(self, fixture_file_info_extractor: IFileInfoExtractor) -> None:
    ...
    def test_get_file_ext(self, fixture_file_info_extractor: IFileInfoExtractor) -> None:
    ...
    def test_get_file_type(self, fixture_file_info_extractor: IFileInfoExtractor) -> None:
    ...
    def test_get_drive_letter_windows(self, fixture_file_info_extractor: IFileInfoExtractor) -> None:
    ...
    def test_get_drive_letter_unix(self, fixture_file_info_extractor: IFileInfoExtractor) -> None:
